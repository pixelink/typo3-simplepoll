# -*- coding: utf-8 -*-
#
# Simple Poll documentation build configuration file, created by
# TYPO3 extension sphinx on Fri, 29 Aug 2014 11:32:09 +0200.
#
...
project = u'Simple Poll'
copyright = u'2014, Alex Bigott'
...
htmlhelp_basename = 'simplepolldoc'
...
latex_documents = [
    ('Index', 'simplepoll.tex', u'Simple Poll',
     u'Alex Bigott', 'manual'),
]
...
pdf_documents = [
    ('Index', 'simplepoll', u'Simple Poll',
     u'Alex Bigott'),
]
...
texinfo_documents = [
    ('Index', 'simplepoll', u'Simple Poll',
     u'Alex Bigott', 'Simple Poll', 'One line description of project.',
     'Miscellaneous'),
]
