...
CREATE TABLE tx_simplepoll_domain_model_simplepoll (
	...
	show_result_link tinyint(1) unsigned DEFAULT '0' NOT NULL,
	show_result_after_vote tinyint(1) unsigned DEFAULT '0' NOT NULL,
	allow_multiple_vote tinyint(1) unsigned DEFAULT '0' NOT NULL,
	answers int(11) unsigned DEFAULT '0' NOT NULL,
	ip_locks int(11) unsigned DEFAULT '0' NOT NULL,
